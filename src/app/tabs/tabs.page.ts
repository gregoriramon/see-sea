...
import { heart, search, calendar, chatbubblesOutline, listOutline, medal } from 'ionicons/icons';
...
export class TabsPage {
  ...
  constructor() {
    addIcons({ heart, search, calendar, 'chatbubbles-outline': chatbubblesOutline, listOutline, medal });
  }
}
