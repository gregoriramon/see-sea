...
import { heart, search, calendar, chatbubblesOutline, listOutline, trophy } from 'ionicons/icons';
...
export class TabsPage {
  ...
  constructor() {
    addIcons({ heart, search, calendar, 'chatbubbles-outline': chatbubblesOutline, listOutline, trophy });
  }
}
